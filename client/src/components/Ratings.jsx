            ...
            <div className="row">
                <div className="col-4 rating-container">
                    {this.props.data.imdb_id && (
                        <a href={`https://www.imdb.com/title/${this.props.data.imdb_id}/`} target="_blank" className="btn btn-sm" rel="noopener noreferrer" data-toggle="tooltip" data-placement="top" title="IMDb">
                            ...
                            <div className="rating pt-1">{!this.props.data.rating_imdb && this.props.data.rating_imdb !== 0 ? '-' : this.props.data.rating_imdb}</div>
                        </a>
                    )}
                    {!this.props.data.imdb_id && (
                ...
                <div className="col-4 rating-container">
                    <div className="btn btn-sm btn-static" data-toggle="tooltip" data-placement="top" title="Rotten Tomatoes">
                        ...
                        <div className="rating pt-1">{!this.props.data.rating_rt && this.props.data.rating_rt !== 0 ? '-' : this.props.data.rating_rt}</div>
                    </div>
                </div>
                <div className="col-4 rating-container">
