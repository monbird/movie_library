                ...
                <div className="container flex-column">
                    <div className="row w-100 mb-2 mb-md-4">
                        <div className="col-8 col-sm-6 col-md-3 pl-0 pl-sm-3 pl-md-0">
                            <div className="row">
                                ...
                                <div className="col-6 pl-2">
                                    <PickRandomButton data={this.props.pieces_visible} highlightMovie={this.props.highlightMovie} disabled={this.props.pieces_visible.length <= 0}/>
                                </div>
                            </div>
                        </div>
                        <div className="col-4 col-sm-6 col-md-3 order-md-3 pr-0 pr-sm-3 pr-md-0 pl-0 pl-sm-3">
                            <Button id="filter-toggler" className="semantic-btn float-right w-100 mr-0" data-toggle="collapse" data-target="#filters" disabled={this.props.pieces_all.length <= 0}>
                        ...
                        <div className="col-12 col-md-6 order-md-2 py-3 py-md-0 px-0 px-sm-3">
                            <Input fluid icon='search' iconPosition='left' placeholder={`Search in ${type_upper}`} disabled={this.props.pieces_all.length <= 0}/>
                        </div>
                    </div>
                    <div id="filters" className="collapse row w-100">
                        <Filters data={this.props.pieces_all} refresher={this.props.refresher} doResetFilters={this.props.doResetFilters}/>
                    </div>
                </div>
            </nav>
        );
